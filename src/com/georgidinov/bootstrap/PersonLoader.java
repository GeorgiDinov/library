...
public class PersonLoader {
    ...
    public static void load(PersonRepository personRepository) {
    ...
    static {
        ...
        //authors
        BookAuthor bookAuthor1 = new BookAuthor("John", "Doe", LocalDate.of(1980, 10, 5), "USA");
        personList.add(bookAuthor1);
        BookAuthor bookAuthor2 = new BookAuthor("Jane", "Dope", LocalDate.of(1985, 9, 6), "Germany");
        ...
        BookAuthor bookAuthor5 = new BookAuthor("Dan", "White", LocalDate.of(1980, 10, 5), "USA");
        personList.add(bookAuthor5);
        BookAuthor bookAuthor6 = new BookAuthor("James", "Gosling", LocalDate.of(1960, 9, 6), "USA");
        personList.add(bookAuthor6);
        BookAuthor bookAuthor7 = new BookAuthor("Richy", "Blakemore", LocalDate.of(1945, 2, 9), "USA");
        ...
        BookAuthor bookAuthor9 = new BookAuthor("Iron", "MikeTyson", LocalDate.of(1956, 12, 19), "USA");
        personList.add(bookAuthor9);
        BookAuthor bookAuthor10 = new BookAuthor("Glen", "Morrison", LocalDate.of(1956, 7, 14), "USA");
        personList.add(bookAuthor10);
        BookAuthor bookAuthor11 = new BookAuthor("Heavy", "Metal", LocalDate.of(1970, 12, 12), "USA");
        personList.add(bookAuthor11);
        BookAuthor bookAuthor12 = new BookAuthor("Captain", "America", LocalDate.of(1958, 3, 3), "USA");
        personList.add(bookAuthor12);
        BookAuthor bookAuthor13 = new BookAuthor("First", "Avenger", LocalDate.of(1972, 5, 9), "Mars");
